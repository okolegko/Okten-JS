...
clients = [
  ...
  new Client(3, 'putin', 'Khuilo', 'putin.khuilo@mail.ru', '+564738291', [{ title: 'Headphones', price: 1500 }]),
  new Client(4, 'putin', 'Khuilo', 'putin.khuilo@mail.ru', '+456123789', [{ title: 'Smartwatch', price: 3000 }, { title: 'Camera', price: 12000 }]),
  new Client(5, 'putin', 'Khuilo', 'putin.khuilo@mail.ru', '+987123654', [{ title: 'Monitor', price: 5000 }]),
  new Client(6, 'putin', 'Khuilo', 'putin.khuilo@mail.ru', '+321654987', [{ title: 'Mouse', price: 600 }, { title: 'Tablet', price: 8000 }]),
  new Client(7, 'putin', 'Khuilo', 'putin.khuilo@mail.ru', '+159753258', [{ title: 'Printer', price: 4500 }]),
...
// 4. Сортування по кількості товарів в полі order по зростанню і виведення у консоль
